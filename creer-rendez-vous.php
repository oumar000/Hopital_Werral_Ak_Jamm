...
if(isset($_POST['submit'])){
    ...
    //Inserer un nouveau rendez-vous dans la base de données
    $sql = "INSERT INTO `rendez_vous` (Nom, Prenom, motif_RV, date_RV) VALUES('$Nom','$Prenom','$motif_RV', '$date_RV')";
                ...
                <form class="p-left" method="POST">
                    ...
                    <div class="row mb-3 mt">
                        ...
                        <div class="col-sm-3 d-grid">
                            <a href="" class="btn btn-outline-primary" href="lister-rendez-vous.php">Retour</a>
                        </div>
                    </div>
                </form>  
            </div>
