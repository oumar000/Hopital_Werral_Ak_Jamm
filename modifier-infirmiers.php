...
$Tel_infirmier="";
$Ad_infirmier="";
$Num_infirmier=$_GET['updateid'];
$sql = "select * from `infirmier` where Num_infirmier=$Num_infirmier";
...
if(isset($_POST['submit'])){
    ...
    $sql = " update `infirmier` set Num_infirmier=$Num_infirmier,Nom_infirmier='$Nom_infirmier',Prenom_infirmier='$Prenom_infirmier',Tel_infirmier='$Tel_infirmier',Ad_infirmier='$Ad_infirmier' where Num_infirmier=$Num_infirmier";
    $result = mysqli_query($con,$sql);
    if($result){
