...
if(isset($_POST['submit'])){
    ...
    //Inserer un nouveau medecin dans la base de données
    $sql = "INSERT INTO `medecin` (Nom_medecin, Prenom_medecin, specialité, Tel_medecin, Ad_medecin, id_devoir) VALUES('$Nom_medecin', '$Prenom_medecin','$specialité','$Tel_medecin','$Ad_medecin','$id_devoir')";
