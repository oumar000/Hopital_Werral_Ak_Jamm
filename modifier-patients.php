...
$Groupe_sanguin="";
$Num_medecin="";
$Num_dossier=$_GET['updateid'];
$sql = "select * from `patient` where Num_dossier=$Num_dossier";
...
if(isset($_POST['submit'])){
    ...
    $sql = " update `patient` set Num_dossier=$Num_dossier,Nom_patient='$Nom_patient',Prenom_patient='$Prenom_patient',Date_de_naissance='$Date_de_naissance',Ad_patient='$Ad_patient',Tel_patient='$Tel_patient',Sexe='$Sexe',Antecedent_Medical='$Antecedent_Medical',Groupe_sanguin='$Groupe_sanguin',Num_medecin='$Num_medecin' where Num_dossier=$Num_dossier";
    $result = mysqli_query($con,$sql);
    if($result){
