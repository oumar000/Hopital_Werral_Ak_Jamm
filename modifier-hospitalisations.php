...
$Num_hospitalisation=$_GET['updateid'];
$sql = "select * from `hospitalisation` where Num_hospitalisation=$Num_hospitalisation";
...
if(isset($_POST['submit'])){
    ...
    //Modifier une hospitalisation dans la base de données
    $sql = " update `hospitalisation` set Num_hospitalisation=$Num_hospitalisation,Date_dentree='$Date_dentree',Date_sortie='$Date_sortie',num_chambre='$num_chambre',num_dossier='$num_dossier'where Num_hospitalisation=$Num_hospitalisation";
    $result = mysqli_query($con,$sql);
    if($result){
